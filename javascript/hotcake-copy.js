...
$("#int").on("keyup search",function(){
    ...
    $("#searchBtn").click(function(){
        ...
        $(".hot-cake-col").hide()
        if(name!=""){
            $(`.hot-cake-row>.hot-cake-col:contains(${name})`).show()
...
function chose(me){
    ...
    $(".hot-cake-col").hide()
    $(`.hot-cake-col:contains(${allen})`).show()
...
let control3 = document.getElementById("control-three")
...
function add(me){
   ...
   $(".control-cake>button").click(function(){
    $(".control-cake>button").css("color","black")
    $(this).css("color","red")
